...
static const char *fonts[]          = { "Ubuntu Mono:size=10", "monospace:size=10" };
...
static const char col_red[]        = "#8a8a8a";
...
static const char *audioLower[]  = { "ponymix", "decrease", "5" , NULL };
static const char *audioRaise[]  = { "ponymix", "increase", "5" , NULL };
...
static const char *audioStop[]  = { "mpc", "toggle", NULL };
static const char *audioRaiseVol[]  = { "mpc", "volume", "+5", NULL };
static const char *audioLowerVol[]  = { "mpc", "volume", "-5", NULL };
